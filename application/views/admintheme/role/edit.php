                        ...
                        <form role="form" method="post" name="add_role" id="add_role" action="" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="role" placeholder="Enter Role" name="role" value="<?php echo $role['role'];?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    if(!empty($access_pages))
                                    {
                                        ...
                                        {
                                            $checked="";
                                            $page_method=strtolower($page['controller']).'/'.strtolower($page['method']);
                                            if(in_array(strtolower($page['controller']), $controller) && in_array($page_method, $method))
                                                $checked='checked="checked"';    
                                    ?>
                                            <input type="checkbox" name="access[]" class="checked" value="<?php echo strtolower($page['controller']).'/'.strtolower($page['method']);?>" <?php echo $checked;?>> <?php if(isset($page['page_name']) && $page['page_name']!=""){echo $page['page_name'];}else{ echo $page['controller'].'/'.$page['method'];}?>
                                            <?php
