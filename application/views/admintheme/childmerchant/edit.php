    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Edit Child Merchant</li>
            </ol>
        </section>
                        ...
                        <form role="form" method="post" name="add_child_merchant" id="add_child_merchant" action="<?php echo base_url().'admin/cmerchant/add';?>" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cm_type_id" id="cm_type_id">
                                      <option value="<?php echo $child_merchant['cm_type_id'];?>">
                                        <?php
                                        if($child_merchant['cm_type_id'] == 1)
                                          echo "Sole Proprietor";
                                        elseif($child_merchant['cm_type_id'] == 2)
                                          echo "Partnership";
                                        elseif($child_merchant['cm_type_id'] == 3)
                                            echo "Goverment Controlled";
                                        elseif($child_merchant['cm_type_id'] == 4)
                                              echo "Private Ltd Company";
                                        elseif($child_merchant['cm_type_id'] == 5)
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="bd_merchant_id" name="bd_merchant_id" readonly value="<?php echo $child_merchant['bd_merchant_id'];?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cm_name" placeholder="Enter Merchant Name" name="cm_name" value="<?php echo $child_merchant['cm_name'];?>">
                                </div>
                                <span style="color:red;"><?php echo form_error('cm_name');?></span>

                                <div class="form-group">
                                     <label for="exampleInputEmail1">Return Url*</label>
                                     <input type="text" class="form-control" placeholder="Enter Return URL" value="<?php echo $child_merchant['cm_return_url'];?>" name="cm_return_url" id="cm_return_url">
                                 </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Merchant Email" name="cm_email" id="cm_email" value="<?php echo $child_merchant['cm_email'];?>">
                                </div>
                                <span style="color:red;"><?php echo form_error('email');?></span>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Mobile No*</label>
                                    <input type="text" class="form-control" placeholder="Enter Mobile No" name="mobile_no_1" id="mobile_no_1" value="<?php echo $child_merchant['mobile_no_1'];?>">
                                </div>
                                 <span style="color:red;"><?php echo form_error('mobile_no_1');?></span>

                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Alternate Mobile No</label>
                                    <input type="text" class="form-control" placeholder="Enter Alternate Mobile No" name="mobile_no_2" id="mobile_no_2" value="<?php echo $child_merchant['mobile_no_2'];?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter LandLine No" name="land_line_1" id="land_line_1" value="<?php echo $child_merchant['land_line_1'];?>">
                                </div>
                                 <span style="color:red;"><?php echo form_error('land_line_1');?></span>

                                 <div class="form-group">
                                    <label for="exampleInputEmail1">Alternate Landline No</label>
                                    <input type="text" class="form-control" placeholder="Enter Alternate LandLine No" name="land_line_2" id="land_line_2 value="<?php echo $child_merchant['land_line_2'];?>"">
                                </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Address 1" name="cm_address_1" id="cm_address_1" value="<?php echo $child_merchant['cm_address_1'];?>">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Address 2" name="cm_address_2" id="cm_address_2" value="<?php echo $child_merchant['cm_address_2'];?>">
                                </div>
                                 <span style="color:red;"><?php echo form_error('cm_address_2');?></span>

                                 <div class="form-group">
                                     <label for="exampleInputEmail1">Location/City/Village/Town</label>
                                     <input type="text" class="form-control" placeholder="Enter Location" name="cm_location" id="cm_location" value="<?php echo $child_merchant['cm_location'];?>">
                                 </div>
                                  <span style="color:red;"><?php echo form_error('cm_location');?></span>

                                  <div class="form-group">
                                    <label for="exampleInputEmail1">Pincode*</label>
                                    <input type="text" class="form-control" placeholder="Enter Pincode" name="cm_pincode" id="cm_pincode" value="<?php echo $child_merchant['cm_pincode'];?>">
                                </div>
                                ...
                                <!-- <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter District" name="cm_district" id="cm_district" value="<?php echo $child_merchant['cm_district'];?>">
                                </div>
                               ...
                               <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter State" name="cm_state" id="cm_state" value="<?php echo $child_merchant['cm_state'];?>">
                                </div>
                               ...
                               <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Country" name="cm_country" id="cm_country" value="INDIA" readonly>
                                </div>
