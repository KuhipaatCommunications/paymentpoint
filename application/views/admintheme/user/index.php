                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                                ...
                                <a href="<?php echo base_url().'/admin/user/add'?>" style="float:right; margin:8px 0 0 0; " > <button class="btn btn-primary">Add</button></a>
                        </div><!-- /.box-header -->
                            ...
                            <table id="usertab" class="table table-bordered table-striped">
                                    ...
                                    ?>
                                            <tr>
                                                    ...
                                                    <td> 
                                                        <a href="<?php echo base_url('/admin/user/view/'.$row["id"])?>" style="cursor:pointer;"><img src="<?php echo $this->config->item('admin_theme_url')?>images/view.jpeg" alt="View" title="View" border="0" /></a>&nbsp;&nbsp;&nbsp;
                                                        <a href="<?php echo base_url('/admin/user/edit'); ?>/<?php echo $row["id"]; ?>"><img src="<?php echo $this->config->item('admin_theme_url')?>images/edit.png" alt="Edit" title="Edit" border="0" /></a>&nbsp;&nbsp;&nbsp;
                                                        <a href="javascript:void(0)" onclick="delete_single('user/delete', <?php echo $row["id"]; ?>)"><img src="<?php echo $this->config->item('admin_theme_url')?>images/b_drop.png" alt="Delete" title="Delete" border="0" /></a>
                                                    </td>
                                            </tr>
                                    <?php }
                                    } ?>	
