...
<!--                                <div class="form-group">
                                    <label for="exampleInputEmail1">User Type</label>
                                    <input type="radio" class="form-control" name="user_type_id" id="user_type_id" value="2">Landlord
                                    <input type="radio" class="form-control" name="user_type_id" id="user_type_id" value="3">Tenant
                                    <label class="error" for="user_type_id" generated="true"></label>
                                </div>-->
                            </div><!-- /.box-body -->
